...
async def reiniciar(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    result = subprocess.run(['/usr/bin/sudo','/usr/bin/systemctl', 'restart', configuracion['application']['name']], stdout=subprocess.PIPE)
...
async def apagar(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    result = subprocess.run(['/usr/bin/sudo','/usr/bin/systemctl', 'stop', configuracion['application']['name']], stdout=subprocess.PIPE)
